<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:67:"D:\lyk\public/../application/wycadmin\view\journey\journey_add.html";i:1558141987;s:51:"D:\lyk\application\wycadmin\view\public\header.html";i:1555747040;s:49:"D:\lyk\application\wycadmin\view\public\menu.html";i:1555747004;s:55:"D:\lyk\application\wycadmin\view\public\headerInfo.html";i:1556608616;s:55:"D:\lyk\application\wycadmin\view\public\pageHeader.html";i:1547777422;s:53:"D:\lyk\application\wycadmin\view\public\dropDown.html";i:1547739334;s:51:"D:\lyk\application\wycadmin\view\public\footer.html";i:1555746880;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6"
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*景区名称</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="sc_name" value="<?php echo $scenic_name; ?>" disabled><span
                                            class="help-block m-b-none text-danger"></span></div>
                                </div>
                                <input type="hidden" name="sc_id" value="<?php echo $scenic_id; ?>">
                                ...
                                <!--<div class="form-group"><label class="col-sm-2 control-label">*可预约卡</label>-->
                                    <!--<div class="col-sm-10"><select name="card_id" class="form-control">-->
                                        ...
                                        <!--<option value="<?php echo $co->card_id; ?>"><?php echo $co->title; ?></option>-->
                                        <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
                                    <!--</select>-->
                                    <!--</div>-->
                                <!--</div>-->
