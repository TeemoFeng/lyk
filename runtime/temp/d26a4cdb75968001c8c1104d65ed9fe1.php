                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('journey/journeyadd'); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><?php echo $vo->s_time; ?>-<?php echo $vo->e_time; ?></td>
                                            <td><?php echo $vo->w_vehicle; ?></td>
                                            <td><?php echo $vo->site; ?></td>
                                            <!--<td><?php echo $vo->s_time; ?></td>-->
                                            <!--<td><?php echo $vo->e_time; ?></td>-->
                                            <td><?php echo $vo->max_people_count; ?></td>
                                            <td><?php echo $vo->this_people_count; ?></td>
                                            <td><?php echo $vo->w_status; ?></td>
                                            <td>
                                                <a href="<?php echo url('journey/journeyedit',['id'=>$vo->id]); ?>" class="btn btn-sm btn-success">编辑</a>
...
<script type="text/javascript">
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('journey/journeyStatusUpdate'); ?>",key,status)
    }
</script>
