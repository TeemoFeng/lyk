                            ...
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6"
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*景点类型</label>
                                    <div class="col-sm-10"><select name="category_id" class="form-control">
                                        ...
                                        <option value="<?php echo $reg['id']; ?>"><?php echo str_repeat('&nbsp;&nbsp;',$reg['level']); ?>└<?php echo $reg['title']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">*景区标题</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" name="title"><span
                                            class="help-block m-b-none text-danger">(标题最长64个字符)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*简介</label>

                                    <div class="col-sm-10"><input type="text" class="form-control" name="intro"><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*景区所在地</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="addr"><span
                                            class="help-block m-b-none text-danger">(最长64字)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*星级</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="star"><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">景区介绍</label>
                                    <div class="col-sm-10"><textarea name="introduce" id="introduce" style="width:100%;height:400px;"></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-primary" type="button" onclick="infoSubmit()">新增
                                        </button>
                                    </div>
                                </div>
                            </form>
...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        editor1.render("introduce");//此处的EditorId与<textarea name="content" id="EditorId">的id值对应 </textarea>  
    }

    function getRegion(tt) {
        pid = $(tt).val()
        $.ajax({
            url:"<?php echo url('scenic/getRegionSon'); ?>",
            type:'get',
            data:'pid='+pid,
            dataType:'json',
