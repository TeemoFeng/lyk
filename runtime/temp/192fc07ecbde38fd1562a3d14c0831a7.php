                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('region/regionadd',['pid'=>$pid]); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td>
                                                <a href="<?php echo url('region/regionlist',['pid'=>$vo->id]); ?>" class="btn btn-sm btn-primary">查看下级</a>
                                                <a href="<?php echo url('region/regionedit',['id'=>$vo->id]); ?>}}" class="btn btn-sm btn-success">编辑</a>
...
<script type="text/javascript">
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('region/regionStatusUpdate'); ?>",key,status)
    }
</script>
