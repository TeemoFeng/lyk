                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6"
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">景区须知</label>
                                    <div class="col-sm-10"><textarea name="notice" id="notice" style="width:100%;height:400px;"></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">自驾游线路</label>
                                    <div class="col-sm-10"><textarea name="circuit" id="circuit" style="width:100%;height:400px;"></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        editor2.render("circuit");//此处的EditorId与<textarea name="content" id="EditorId">的id值对应 </textarea> 
    }
