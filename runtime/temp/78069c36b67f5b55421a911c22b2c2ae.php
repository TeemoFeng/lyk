                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-body">
                            <a href="<?php echo url('category/categoryadd'); ?>" class="btn  btn-success">新增</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td><img src="<?php echo $vo->w_image_path; ?>" alt="" width="40px" height="40px"></td>
                                            <td><?php echo $vo->w_display; ?></td>
                                            <td><?php echo $vo->content; ?></td>
                                            <td><?php echo $vo->sort; ?></td>
                                            <td><?php echo $vo->parent_title; ?></td>
                                            <td><?php echo $vo->all_parent; ?></td>
                                            <td><?php echo $vo->create_time; ?></td>
                                            <td><?php echo $vo->update_time; ?></td>
                                            <td><?php echo $vo->w_status; ?></td>
                                            <td>
                                                <a href="<?php echo url('category/categoryedit'); ?>?id=<?php echo $vo->id; ?>&cid=<?php echo $vo->cid; ?>" class="btn btn-sm btn-success">编辑</a>
...
<script type="text/javascript">
  highlight_subnav();
    ...
    function updateStatus(key = '',status = 1) {
        modifyByKeys("<?php echo url('category/categoryStatusUpdate'); ?>",key,status)
    }
</script>
