                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6">
                                <div class="form-group"><label class="col-sm-2 control-label">*标题</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="title"><span class="help-block m-b-none text-danger">(标题最长32个字符)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*介绍</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="content"><span class="help-block m-b-none text-danger">(标题最长128个字符)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*显示类型</label>
                                    <div class="col-sm-10">
                                        <label for="display_type1" style="display: inline-block;margin-top:7px;margin-right: 10px">
                                            <input id="display_type1" type="radio" checked="checked" value="1"  class="" name="display_type"> 分月显示
                                        </label>
                                        <label for="display_type2" style="display: inline-block;margin-top:7px">
                                            <input id="display_type2" type="radio" value="2" class="" name="display_type"> 全部显示
                                        </label>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*权限值</label>
                                    <div class="col-sm-10"><input type="number" class="form-control"   name="sort"><span class="help-block m-b-none text-danger">(填写1-127数字越大排序靠前)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">类型</label>
                                    <div class="col-sm-10"><select name="cid" class="form-control">
                                        ...
                                        <option value="<?php echo $vo['id']; ?>" <?php if(\think\Request::instance()->get('id')==$vo['id']): ?> selected <?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;',$vo['level']); ?>└<?php echo $vo['title']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
