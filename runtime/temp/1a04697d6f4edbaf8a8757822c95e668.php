                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6"
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*景区id</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="sc_id" value="<?php echo $info->sc_id; ?>"><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*门票价格</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="tickets_price" value="<?php echo $info->tickets_price; ?>"><span
                                            class="help-block m-b-none text-danger">(1-9999999)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*押金/人</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="cash" value="<?php echo $info->cash; ?>"><span
                                            class="help-block m-b-none text-danger">(1-9999999)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*预约分类</label>
                                    <div class="col-sm-10"><select name="cid" class="form-control">
                                        ...
                                        <option value="<?php echo $vo['id']; ?>" <?php if($info->cid==$vo['id']): ?> selected <?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;',$vo['level']); ?>└<?php echo $vo['title']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">*可预约卡</label>
                                    <div class="col-sm-10"><select name="card_id" class="form-control">
                                        ...
                                        <option value="<?php echo $co->card_id; ?>" <?php if($info->card_id == $co->card_id): endif; ?>><?php echo $co->title; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">*出行工具</label>
                                    <div class="col-sm-10"><select name="v_id" class="form-control" >
                                        ...
                                        <option value="<?php echo $vo->id; ?>" <?php if($info->v_id == $vo->id): endif; ?>><?php echo $vo->title; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*可预约人数</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="max_people_count" value="<?php echo $info->max_people_count; ?>"><span
                                            class="help-block m-b-none text-danger">(1-9999)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*咨询电话</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="mobile"  value="<?php echo $info->mobile; ?>"><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">乘车地点</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="site" value="<?php echo $info->site; ?>" ><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*开始时间</label>
                                    <div class="col-sm-10"><input type="date" class="form-control" name="s_time" value="<?php echo $info->s_time; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*结束时间</label>
                                    <div class="col-sm-10"><input type="date" class="form-control" name="e_time" value="<?php echo $info->e_time; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="hr-line-dashed"></div>
