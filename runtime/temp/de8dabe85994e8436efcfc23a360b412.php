<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:68:"D:\lyk\public/../application/wycadmin\view\journey\journey_add2.html";i:1558112155;s:51:"D:\lyk\application\wycadmin\view\public\header.html";i:1555747040;s:49:"D:\lyk\application\wycadmin\view\public\menu.html";i:1555747004;s:55:"D:\lyk\application\wycadmin\view\public\headerInfo.html";i:1556608614;s:55:"D:\lyk\application\wycadmin\view\public\pageHeader.html";i:1547777422;s:53:"D:\lyk\application\wycadmin\view\public\dropDown.html";i:1547739334;s:51:"D:\lyk\application\wycadmin\view\public\footer.html";i:1555746880;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content clearfix">
                            <form method="post" id="newsinfo" class="form-horizontal col-lg-6"
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*景区id</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="sc_id" value="<?php echo $scenic_id; ?>" ><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*门票价格</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="tickets_price"><span
                                            class="help-block m-b-none text-danger">(1-9999999)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*押金/人</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="cash"><span
                                            class="help-block m-b-none text-danger">(1-9999999)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>

                                <div class="form-group"><label class="col-sm-2 control-label">*预约分类</label>
                                    <div class="col-sm-10"><select name="cid" class="form-control">
                                        <?php if(is_array($List) || $List instanceof \think\Collection || $List instanceof \think\Paginator): $i = 0; $__LIST__ = $List;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $vo['id']; ?>" <?php if($category_id==$vo['id']): ?> selected <?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;',$vo['level']); ?>└<?php echo $vo['title']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    </div>
                                </div>
                                <!--<div class="form-group"><label class="col-sm-2 control-label">*可预约卡</label>-->
                                    <!--<div class="col-sm-10"><select name="card_id" class="form-control">-->
                                        <!--<?php if(is_array($Card) || $Card instanceof \think\Collection || $Card instanceof \think\Paginator): $i = 0; $__LIST__ = $Card;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?>-->
                                        <!--<option value="<?php echo $co->card_id; ?>" <?php if($category_id == $vo['id']): ?>selected <?php endif; ?>><?php echo $co->title; ?></option>-->
                                        <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
                                    <!--</select>-->
                                    <!--</div>-->
                                <!--</div>-->
                                <div class="form-group"><label class="col-sm-2 control-label">*出行工具</label>
                                    <div class="col-sm-10"><select name="v_id" class="form-control">
                                        <?php if(is_array($Vehicle) || $Vehicle instanceof \think\Collection || $Vehicle instanceof \think\Paginator): $i = 0; $__LIST__ = $Vehicle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*可预约人数</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="max_people_count"><span
                                            class="help-block m-b-none text-danger">(1-9999)</span></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*咨询电话</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="mobile"><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">乘车地点</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="site"><span
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">*开始时间</label>
                                    <div class="col-sm-10"><input type="date" class="form-control" name="s_time"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">*结束时间</label>
                                    <div class="col-sm-10"><input type="date" class="form-control" name="e_time"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="hr-line-dashed"></div>
